...
//
//import com.simple.player.MusicEventHandler.onHeadImageVisibilityChangedListenerList
//
///**
...
//    private val onHeadImageVisibilityChangedListenerList = ArrayList<MusicEvent.OnHeadImageVisibilityChangedListener>(SIZE)
//    private val onBottomPlayerBarStyleChangedListener = ArrayList<MusicEvent.OnBottomPlayerBarStyleChangedListener>(SIZE)
//
...
//        }
//        if (any is MusicEvent.OnHeadImageVisibilityChangedListener) {
//            onHeadImageVisibilityChangedListenerList.add(any)
//        }
//        if (any is MusicEvent.OnBottomPlayerBarStyleChangedListener) {
//            onBottomPlayerBarStyleChangedListener.add(any)
//        }
//    }
//
...
//        }
//        if (any is MusicEvent.OnHeadImageVisibilityChangedListener) {
//            onHeadImageVisibilityChangedListenerList.remove(any)
//        }
//        if (any is MusicEvent.OnBottomPlayerBarStyleChangedListener) {
//            onBottomPlayerBarStyleChangedListener.remove(any)
//        }
//    }
//
...
//            listener.onHistoryChanged(newSongId)
//        }
//    }
//
//    fun executeOnHeadImageVisibilityChangedListener(visible: Boolean) {
//        for (listener in onHeadImageVisibilityChangedListenerList) {
//            listener.onHeadImageVisibilityChanged(visible)
//        }
//    }
//
//    fun executeOnBottomPlayerBarStyleChangedListener(style: String) {
//        for (listener in onBottomPlayerBarStyleChangedListener) {
//            listener.onBottomPlayerBarStyleChanged(style)
//        }
//    }
//
//
